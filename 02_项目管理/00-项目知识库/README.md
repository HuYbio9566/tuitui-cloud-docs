...
3. 阅读 [../../08-版本与发布/版本历史.md](../../08-版本与发布/版本历史.md)，确认当前版本和可回滚点。
4. 如果涉及视觉或交互，阅读 [../../../03_设计资料/设计规范/DESIGN.md](../../../03_设计资料/设计规范/DESIGN.md) 和 [EVIDENCE_INDEX.md](EVIDENCE_INDEX.md)。
...
- 版本变化同时更新 `08-版本与发布/当前版本.txt`、`版本历史.md` 和 `CHANGELOG.md`。
- 任务完成后，把结果、验证命令、遗留问题写入任务文件或复盘记录。
- 不把临时目录 `/var/folders/...` 作为长期证据路径。

## 当前入口

- 当前版本：读取 [08-版本与发布/当前版本.txt](../../08-版本与发布/当前版本.txt)。
- 当前工作文件：[Cloud Docs Redesign v5 AI Modes.html](../../../05_网站程序（电脑使用）/当前工作稿/Cloud%20Docs%20Redesign%20v5%20AI%20Modes.html)。
- 当前稳定回滚快照：[Cloud Docs Redesign v1.2.1.html](../../../05_网站程序（电脑使用）/产品快照/1.2.1/Cloud%20Docs%20Redesign%20v1.2.1.html)。
