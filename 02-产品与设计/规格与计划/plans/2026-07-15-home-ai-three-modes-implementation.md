...
**Files:**
- Create: `03-代码与原型/工作稿/Cloud Docs Redesign v5 AI Modes.html`
- Source: `03-代码与原型/archive/方案演进/03-Autoplan-Cloud Docs Redesign v4.html`
...
```bash
cp '03-代码与原型/archive/方案演进/03-Autoplan-Cloud Docs Redesign v4.html' '03-代码与原型/工作稿/Cloud Docs Redesign v5 AI Modes.html'
```
...
**Files:**
- Modify: `03-代码与原型/工作稿/Cloud Docs Redesign v5 AI Modes.html`
...
Check every acceptance criterion in `02-产品与设计/规格与计划/specs/2026-07-15-home-ai-three-modes-design.md` against the actual rendered v5 file. Record any mismatch and fix it before completion.
