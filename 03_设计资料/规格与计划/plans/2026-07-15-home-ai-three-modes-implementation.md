...
Check every acceptance criterion in `03_设计资料/规格与计划/specs/2026-07-15-home-ai-three-modes-design.md` against the actual rendered v5 file. Record any mismatch and fix it before completion.
